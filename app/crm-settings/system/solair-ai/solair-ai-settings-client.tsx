...
const AIUTO: Record<EntitaAI, string> = {
  lead: "Fonte autorizzata per letture esplicite sui lead.",
  cliente: "Fonte autorizzata per letture esplicite sui clienti.",
  installatore: "Fonte autorizzata per letture esplicite sugli installatori.",
}
...
export function SolairAiSettingsClient({
  ...
  return (
    <div className="flex flex-col gap-6">
      <SectionHeader
        title="SolairAI"
        description="Fonti Nextcloud autorizzate per le letture esplicite. La sincronizzazione SolairAI con Nextcloud e' stata rimossa."
        action={
          canManage ? (
      ...
      <p className="text-xs leading-relaxed text-muted-foreground">
        SolairAI non avvia piu&apos; check, sync o letture massive su Nextcloud da questa pagina.
      </p>
    </div>
  )
}
