      ...
      <DropdownMenu>
        ...
        <DropdownMenuContent align="end" className="w-60">
          {hasSelection ? (
            <>
              <DropdownMenuGroup>
                <DropdownMenuLabel>{selectedCount} selezionati</DropdownMenuLabel>
            ...
            <DropdownMenuGroup>
              ...
              <DropdownMenuItem disabled>
                Seleziona uno o più installatori per abilitare le azioni di massa.
              </DropdownMenuItem>
            </DropdownMenuGroup>
          )}
        </DropdownMenuContent>
      ...
      <Dialog open={transferOpen} onOpenChange={setTransferOpen}>
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              Assegna i {selectedCount} installatori selezionati a un nuovo proprietario.
            </DialogDescription>
          </DialogHeader>
