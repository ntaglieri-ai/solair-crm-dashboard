...
import {
  ...
  MAX_INSTALLATORE_TAGS,
  isLightColor,
  type InstallatoreTag,
} from "@/lib/installatore-tag-store"

function InstallatoreTagPill({ tag }: { tag: InstallatoreTag }) {
      ...
      <div className="flex flex-wrap items-center justify-between gap-3">
        ...
        <div className="flex flex-col items-end gap-1">
          ...
          <span className="text-xs text-muted-foreground">
            Tag utilizzati: {tags.length} / {MAX_INSTALLATORE_TAGS}
          </span>
        </div>
      </div>
...
export function InstallatoreTagSection() {
  return (
    <InstallatoreTagProvider>
      <TagManager />
    </InstallatoreTagProvider>
