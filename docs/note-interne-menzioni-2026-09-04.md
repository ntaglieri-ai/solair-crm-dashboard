...
- Email generica con link alla sezione riservata: non include testo della nota o nome del cliente. Nessun accesso aggiuntivo viene concesso dalla menzione.
...
- 238 test passati in 28 file: guard, permessi/scope destinatari, input contraffatto, persistenza, errori, destinatari già notificati, conflitti di aggiornamento e suite preesistente.
