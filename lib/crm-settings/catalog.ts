...
export const CRM_SETTINGS_GROUPS: Record<CrmSettingsGroupId, CrmSettingsGroup> = {
  ...
  communication: {
    id: "communication",
    title: "Comunicazioni",
    description: "Canali, modelli e-mail e regole di invio",
    eyebrow: "Comunicazioni",
    subtitle: "Canali di invio e contenuti riutilizzabili",
    meta: "Canali e contenuti",
    icon: Mail,
...
export const CRM_SETTINGS_CATALOG: CrmSettingsCatalogItem[] = [
  ...
  },
  {
    ...
    group: "ai-features",
    title: "SolairAI",
    description: "Cartelle Nextcloud da cui SolairAI legge i documenti",
    href: "/crm-settings/system/solair-ai",
    pageKey: "crm_settings.system.solair_ai",
    icon: Sparkles,
    status: "active",
  },
  {
  ...
  },
  {
    ...
    group: "crm-config",
    title: "Layout schede",
    description: "Pagine, blocchi e disposizione dei campi nelle schede record",
    href: "/crm-settings/system/layout",
    pageKey: "crm_settings.system.layout",
    icon: LayoutGrid,
    status: "active",
  },
  {
