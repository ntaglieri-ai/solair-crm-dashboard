...
function mapRow(row: Record<string, unknown>): Lead {
  ...
  return {
    ...
    Valutazione: (row.rating as string) ?? null,
    Punteggio: (row.valutazione as number) ?? 0,
...
const ADVANCED_DB_COLUMN: Record<string, string> = {
  ...
  "Consenso telefono": "consenso_contatto_telefono",
  "Consenso e-mail": "consenso_contatto_email",
  "Consenso WhatsApp": "consenso_contatto_whatsapp",
  "Wallbox richiesto": "wallbox_richiesto",
  Sede: "sede",
