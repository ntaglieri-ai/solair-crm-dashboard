...
export interface LeadActivity {
  ...
  allegati?: import("@/lib/notes/mentions").NoteAttachment[]
}
...
export const LEAD_COLUMNS: LeadColumn[] = [
  ...
  { id: "Punteggio", label: "Punteggio", defaultVisible: false },
...
export const CLIENTE_COLUMNS: ClienteColumn[] = [
  ...
  { id: "Ad Meta", label: "Ad Meta", group: "Anagrafica" },
  { id: "Adset Meta", label: "Adset Meta", group: "Anagrafica" },
